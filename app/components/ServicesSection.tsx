			...
			<div className="container mx-auto p-2 md:py-8 md:px-12">
				<div className=" p-5 mb-4">
					...
					<p className="mt-4 text-lg leading-8 text-slate-500 mb-4">
						At Atlas Optronics, you are a decisive step ahead: Customer service does not start with the sale of a system, but long before.
					</p>
				</div>
